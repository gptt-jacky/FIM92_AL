...
│  │7 In+IO7 Out │ │6 In+IO7+IO8 │ │7 In+IO7 Out │ │7 In+IO7 Out │          │
│  └─────────────┘ └─────────────┘ └─────────────┘ └─────────────┘          │
│                         USB / Device Network                            │
...
> - 通訊規格書請見 [COMM_SPEC V0.7](docs/COMM_SPEC.md) / [V0.8](docs/COMM_SPEC_V08.md)
